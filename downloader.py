...
def crawler(save_path, url):
    ...
    for img_info in img_infos:
        if img_info['code']==0:
            ...
            filename = '%s_%s_%s.%s'%(str(img_info['data']['startdate']), str(img_info['data']['enddate']), copyright, suffix)
...
if __name__=='__main__':
    text = {'images': [{'startdate': '20200113', 'fullstartdate': '202001131600', 'enddate': '20200114', 'url': '/th?id=OHR.MuskOxWinter_ZH-CN2030874541_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp', 'urlbase': '/th?id=OHR.MuskOxWinter_ZH-CN2030874541', 'copyright': '阿拉斯加普拉德霍湾附近的雄性麝牛 (© Oliver Smart/Alamy)', 'copyrightlink': '/search?q=%e9%ba%9d%e7%89%9b&form=hpcapt&mkt=zh-cn', 'title': '', 'quiz': '/search?q=Bing+homepage+quiz&filters=WQOskey:%22HPQuiz_20200113_MuskOxWinter%22&FORM=HPQUIZ', 'wp': True, 'hsh': '04bcc90ad1e543b7a7cf9947da1e06eb', 'drk': 1, 'top': 1, 'bot': 1, 'hs': []}], 'tooltips': {'loading': '正在加载...', 'previous': '上一个图像', 'next': '下一个图像', 'walle': '此图片不能下载用作壁纸。', 'walls': '下载今日美图。仅限用作桌面壁纸。'}}
